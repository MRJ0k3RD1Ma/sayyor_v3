...
class TamplateAnimal extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'age' => Yii::t('app', 'Age'),
            'diseases_id' => Yii::t('app', 'Diseases ID'),
            'test_method_id' => Yii::t('app', 'Test Method ID'),
            ...
            'is_vaccination' => Yii::t('app', 'Is Vaccination'),
            'dead_days' => Yii::t('app', 'Dead Days'),
            'creator_id' => Yii::t('app', 'Creator ID'),
            'consent_id' => Yii::t('app', 'Consent ID'),
