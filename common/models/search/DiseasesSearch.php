...
class DiseasesSearch extends Diseases
{
    ...
    public function exportToExcel(?QueryInterface $query)
    {
        ...
        $sheet->setCellValueExplicitByColumnAndRow($col++, $row, "Toifasi", DataType::TYPE_STRING);
        ...
        foreach ($models as $item) {
            ...
            $sheet->setCellValueExplicitByColumnAndRow($col++, $row, $item->category->name_uz, DataType::TYPE_STRING);
            $sheet->setCellValueExplicitByColumnAndRow($col++, $row, $item->group->name_uz, DataType::TYPE_STRING);
        }
