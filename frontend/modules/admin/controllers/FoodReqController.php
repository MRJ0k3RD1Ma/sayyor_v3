...
use common\models\search\RequirementsSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * FoodReqController implements the CRUD actions for Requirements model.
 */
class FoodReqController extends Controller
{
    /**
     * @inheritDoc
     */
