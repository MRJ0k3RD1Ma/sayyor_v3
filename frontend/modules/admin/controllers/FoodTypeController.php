...
use common\models\search\FoodTypeSearch;
...
class FoodTypeController extends Controller
{
    ...
    {
        if (($model = FoodType::findOne(['id' => $id])) !== null) {
            return $model;
        }

        throw new NotFoundHttpException(Yii::t('food', 'The requested page does not exist.'));
    }
}
