...
$this->title = $model->code.' '.Yii::t('cp','sonli hayvon kasalliklari tashhisi bo`yicha namunani yo`q qilish dalolatnomasi');
    ...
    <div class="row">
        <div class="col-md-6">
            <?php if ($model->state_id == 1): ?>
                <div class="row">
                    <div class="col-md-12">
                        <a href="<?= Url::to(['lab/dest-pdf', 'id' => $model->id]) ?>" class="btn btn-warning">Arizani
                            PDF
