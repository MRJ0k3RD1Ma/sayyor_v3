...
$this->title = Yii::t('food', 'Hayvon kasalliklari tashhisi uchun kelgan namunanlarni yo\'q qilish dalolatnomalari ro\'yhati');
...
//            'code',
                            [
                                'attribute' => 'code',
                                'value' => function ($d) {
                                    $url = Yii::$app->urlManager->createUrl(['/register/destview', 'id' => $d->id]);
