...
$this->title = Yii::t('food', 'Oziq-ovqat havfsizligi bo`yicha kelgan namunalarni yo\'q qilish dalolatnomalari ro\'yhati');
...
//            'code',
                            [
                                'attribute' => 'code',
                                'value' => function ($d) {
                                    $url = Yii::$app->urlManager->createUrl(['/register/destfoodview', 'id' => $d->id]);
